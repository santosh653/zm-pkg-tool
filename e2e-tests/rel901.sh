...
deploy()
{
   ...
   PKG_ABC_LIB_VER=1.0.1493729098; PKG_ABC_LIB_REV=1;
   PKG_ABC_BIN_VER=2.0.1493729587; PKG_ABC_BIN_REV=1;
...
echo "my-abc-bin-ver: my-abc-bin-2"
...
echo "my-abc-svc-ver: my-abc-svc-2"
EOM
